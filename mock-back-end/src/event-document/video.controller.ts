...
@Controller('Twinning/video')
export class VideoController {
  @Get(':documentId/:filename')
  @HttpCode(HttpStatus.OK)
  @Header('Content-Type', 'image/jpeg')
  @Header('Content-Disposition', 'attachment; filename=video.mpd')
  getVideo(@Headers('authorization') authorization: string,
           @Param('documentId') documentId: number,
           @Param('filename') filename: string,
           @Res() res: Response) {
    console.log('Twinning/video - Authorization: ' + authorization + ', documentId: ' + documentId + ', filename: ' + filename);

    createReadStream(path.join(__dirname, '../resources/presentation/video.mpd')).pipe(res);
  }
