...
@NgModule({
  ...
  declarations: [
    ProfileComponent, AboutComponent, PreferencesComponent, UserSettingsComponent, FeedbackComponent
  ],
  exports: [
    SharedModule, ProfileComponent, AboutComponent, PreferencesComponent, UserSettingsComponent, FeedbackComponent
  ],
  providers: [
    CoreService,
    {
